...
export default function ModalReading({ reverse, cardData }) {
  ...
  return (
    <div className={`flex w-[18rem] lg:w-[41.4rem] lg:h-[23rem] lg:mx-4`}>
      <section
        className={`${containerStyle} flex flex-row lg:w-full lg:justify-between gap-4 lg:gap-8`}
      >
        ...
        <aside className="flex flex-col justify-center lg:gap-8 lg:w-2/3">
          ...
          <p className="text-pureWhite text-sm text-justify  font-jost w-[12rem] lg:w-full  lg:text-3xl">
            {cardData?.meaning}
          </p>
        </aside>
      </section>
