    ...
    return (
        <section>
            ...
            <div className="bg-purpleDark w-[35rem] flex flex-col justify-center items-center rounded-3xl lg:w-[68rem] lg:h-[40rem]">
                ...
                <section className={`${styles.scrollbar} flex flex-col w-full h-full lg:overflow-y-scroll items-center justify-center p-4 lg:justify-start lg:gap-32 gap-4 lg:py-4`}>
                  <UserEntries/>
                </section>
